...
class PengalamanKerjaController extends Controller{
    public function index(){
        ...
        return view('backend.pengalaman_kerja.index', compact('pengalaman_keja'));
    }
    public function create(){
        $pengalaman_kerja = null;
        return view('backend.pengalaan_kerja.create', compact('pengalaman_kerja'));
    }
    ...
    public function edit($id){
        ...
        return view('backend.pengalaman-kerja.create', compact('pengalaan_kerja'));
    }
    public function update(Request $request){
        DB::table('pengalaan_kerja')->where('id',$request->id)->update([
            'nama' => $request->nama,
            'jabatan'=>$request->jabatan,
            'tahun_masuk'=>$request->tahun_masuk,
            'tahun_keluar' =>$request->tahun_keluar
